...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6210702326:AAF2zq9iwdrt2nmOSac-AnpbtnOe8iuQYHo"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = '𝙸𝚝𝚊𝚌𝚑𝚒 𝚄𝚌𝚑𝚒𝚑𝚊'
username = 'Itachi_gpt_bot'
